const Leftside = () => {
  return (
    <div className="pt-[40px] sm:pt-[5  0px] md:pt-[60px] lg:pt-[75px] flex flex-col gap-[15px] w-full max-w-[723px]">
        ...
        <button className="bg-[#000000] max-w-[241px] py-[18px] text-center text-white">Enter The Mansion</button>
    </div>
  )
}
